...
function ChooseNewChat(props) {
    ...
    return (
        <div className="col-4 leftScreen">
            <div className="modal fade" id="add-new-contact" tabIndex="-1" aria-labelledby="exampleModalLabel"
                 aria-hidden="true">
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            {/* <form> */}
                            <label htmlFor="floatingTextarea" className="col-form-label">Please enter the contact's
                                username:</label>
                            <div className="form-floating">
                                //TODO required
                                <input type="text" className="form-control newContact"
                                       placeholder="Leave a comment here" id="floatingTextarea"
                                       onChange={getNewContactUsername}></input>
